...
class PipelineV0031:
    ...
    def build(self, pipeline_body_v0_0_31: Optional[shared.PipelineBodyV0031] = None, unstructured_api_key: Optional[str] = None) -> operations.Pipeline1GeneralV0031GeneralPostResponse:
        r"""Pipeline 1"""
        hook_ctx = HookContext(operation_id='pipeline_1_general_v0_0_31_general_post', oauth2_scopes=[], security_source=None)
        ...
        res = operations.Pipeline1GeneralV0031GeneralPostResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
